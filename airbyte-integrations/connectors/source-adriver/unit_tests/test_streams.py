...
import pytest
from source_adriver.source import AdriverStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AdriverStream, "path", "v0/example_endpoint")
    mocker.patch.object(AdriverStream, "primary_key", "test_primary_key")
    mocker.patch.object(AdriverStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = AdriverStream()
