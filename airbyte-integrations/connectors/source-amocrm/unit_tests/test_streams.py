...
import pytest
from source_amocrm.source import AmocrmStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(AmocrmStream, "path", "v0/example_endpoint")
    mocker.patch.object(AmocrmStream, "primary_key", "test_primary_key")
    mocker.patch.object(AmocrmStream, "__abstractmethods__", set())
