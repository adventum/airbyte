...
import pytest
from source_betweenx.source import BetweenxStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BetweenxStream, "path", "v0/example_endpoint")
    mocker.patch.object(BetweenxStream, "primary_key", "test_primary_key")
    mocker.patch.object(BetweenxStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = BetweenxStream()
