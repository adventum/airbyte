...
import pytest
from source_bigo_ads.source import BigoAdsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BigoAdsStream, "path", "v0/example_endpoint")
    mocker.patch.object(BigoAdsStream, "primary_key", "test_primary_key")
    mocker.patch.object(BigoAdsStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = BigoAdsStream()
