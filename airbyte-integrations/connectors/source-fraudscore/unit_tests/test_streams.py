...
import pytest
from source_fraudscore.source import FraudscoreStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FraudscoreStream, "path", "v0/example_endpoint")
    mocker.patch.object(FraudscoreStream, "primary_key", "test_primary_key")
    mocker.patch.object(FraudscoreStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = FraudscoreStream()
