...
import pytest
from source_jagajam.source import JagajamStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(JagajamStream, "path", "v0/example_endpoint")
    mocker.patch.object(JagajamStream, "primary_key", "test_primary_key")
    mocker.patch.object(JagajamStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = JagajamStream()
