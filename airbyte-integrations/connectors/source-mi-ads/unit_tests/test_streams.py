...
import pytest
from source_mi_ads.source import MiAdsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(MiAdsStream, "path", "v0/example_endpoint")
    mocker.patch.object(MiAdsStream, "primary_key", "test_primary_key")
    mocker.patch.object(MiAdsStream, "__abstractmethods__", set())
