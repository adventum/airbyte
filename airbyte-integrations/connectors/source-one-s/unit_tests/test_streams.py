...
import pytest
from source_one_s.source import OneSStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(OneSStream, "path", "v0/example_endpoint")
    mocker.patch.object(OneSStream, "primary_key", "test_primary_key")
    mocker.patch.object(OneSStream, "__abstractmethods__", set())
