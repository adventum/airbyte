...
import pytest
from source_salebot.source import SalebotStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SalebotStream, "path", "v0/example_endpoint")
    mocker.patch.object(SalebotStream, "primary_key", "test_primary_key")
    mocker.patch.object(SalebotStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SalebotStream()
