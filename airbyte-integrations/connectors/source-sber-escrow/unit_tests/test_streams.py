...
import pytest
from source_sber_escrow.source import SberEscrowStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SberEscrowStream, "path", "v0/example_endpoint")
    mocker.patch.object(SberEscrowStream, "primary_key", "test_primary_key")
    mocker.patch.object(SberEscrowStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SberEscrowStream()
