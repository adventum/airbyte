...
import pytest
from source_sendsay.source import SendsayStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SendsayStream, "path", "v0/example_endpoint")
    mocker.patch.object(SendsayStream, "primary_key", "test_primary_key")
    mocker.patch.object(SendsayStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SendsayStream()
