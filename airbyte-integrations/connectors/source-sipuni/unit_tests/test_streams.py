...
import pytest
from source_sipuni.source import SipuniStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SipuniStream, "path", "v0/example_endpoint")
    mocker.patch.object(SipuniStream, "primary_key", "test_primary_key")
    mocker.patch.object(SipuniStream, "__abstractmethods__", set())
