...
import pytest
from source_smartis.source import SmartisStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SmartisStream, "path", "v0/example_endpoint")
    mocker.patch.object(SmartisStream, "primary_key", "test_primary_key")
    mocker.patch.object(SmartisStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SmartisStream()
