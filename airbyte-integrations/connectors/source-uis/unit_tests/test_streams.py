...
import pytest
from source_uis.source import UisStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(UisStream, "path", "v0/example_endpoint")
    mocker.patch.object(UisStream, "primary_key", "test_primary_key")
    mocker.patch.object(UisStream, "__abstractmethods__", set())
