...
from source_yandex_direct.source import IncrementalYandexDirectStream
...
def test_cursor_field(patch_incremental_base_class):
    stream = IncrementalYandexDirectStream()
...
def test_supports_incremental(patch_incremental_base_class, mocker):
    mocker.patch.object(IncrementalYandexDirectStream, "cursor_field", "dummy_field")
    stream = IncrementalYandexDirectStream()
