...
hits_fields: list[YandexMetrikaSourceField] = [
    ...
    YandexMetrikaSourceField("ym:pv:pageViewID", field_type="string"),
    ...
    YandexMetrikaSourceField("ym:pv:recommendationSystem", field_type="string"),
    YandexMetrikaSourceField("ym:pv:messenger", field_type="string"),
    ...
    YandexMetrikaSourceField("ym:pv:screenOrientationName", field_type="string"),
    ...
    YandexMetrikaSourceField("ym:pv:isTurboPage", field_type="string"),
    YandexMetrikaSourceField("ym:pv:isTurboApp", field_type="string"),
    ...
    YandexMetrikaSourceField("ym:pv:ecommerce", field_type="string"),
    YandexMetrikaSourceField("ym:pv:params", field_type="string"),
...
visits_fields: list[YandexMetrikaSourceField] = [
    ...
    YandexMetrikaSourceField(field_name="ym:s:isRobotPro", field_type="boolean"),
    ...
    YandexMetrikaSourceField(
        field_name="ym:s:screenOrientationName", field_type="string"
    ),
