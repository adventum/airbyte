...
from source_yandex_metrika.source import IncrementalYandexMetrikaStream
...
def test_cursor_field(patch_incremental_base_class):
    stream = IncrementalYandexMetrikaStream()
...
def test_supports_incremental(patch_incremental_base_class, mocker):
    mocker.patch.object(IncrementalYandexMetrikaStream, "cursor_field", "dummy_field")
    stream = IncrementalYandexMetrikaStream()
